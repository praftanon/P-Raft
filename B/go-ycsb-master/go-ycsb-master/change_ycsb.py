...
def append_takes_from_log(log_path: str, times_path: str = "/etcd/etcd-release-3.4/timesB.csv") -> None:
    """
...
def append_total_stats_from_log(
    log_path: str,
    times_path: str = "/etcd/etcd-release-3.4/timesB.csv"
) -> None:
    """
